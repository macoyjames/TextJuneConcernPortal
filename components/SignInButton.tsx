  ...
  return (
    ...
    >
      <svg width="18" height="18" viewBox="0 0 48 48">
        ...
        <path
          fill="#4CAF50"
          d="M24 44c5.4 0 10.3-2.1 13.9-5.4l-6.4-5.4C29.4 34.9 26.8 36 24 36c-5.3 0-9.7-3.1-11.3-7.7l-6.5 5C9.6 39.6 16.2 44 24 44z"
        />
        <path
          fill="#1976D2"
          d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.3-4.2 5.7l6.4 5.4C40.8 36.4 44 30.8 44 24c0-1.3-.1-2.7-.4-3.5z"
        />
      </svg>
      Sign in with Google
    </button>
